...
fun ConfirmDialog(
    ...
    if (state.isConfirmVisible) {
        ...
        AlertDialog(
            onDismissRequest = {
                onEvent(DeliverStore.Intent.OnCloseConfirm)
            },
            title = {
                Row(
                    ...
                    IconButton(
                        onClick = {
                            onEvent(DeliverStore.Intent.OnBackToOrder)
                        }
                    ) {
                ...
                Column(
                    ...
                    OtpTextField(
                        ...
                        onOtpTextChange = { value ->
                            onEvent(DeliverStore.Intent.OnOtpChanged(value))
                        }
                    )
                    Spacer(Modifier.height(16.dp))
                    if (downTime == 0) {
                        ...
                        Text(text = downTime.toString(), fontSize = 18.sp)
                    }
                }
            },
            confirmButton = {
                if(state.isConfirmBtnLoading) {
                    ...
                    AppButton(
                        onClick = {
                            ...
                            onEvent(DeliverStore.Intent.OnConfirmClicked)
                        },
